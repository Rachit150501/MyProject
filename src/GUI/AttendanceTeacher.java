...
public class AttendanceTeacher {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	AttendanceTeacher window = new AttendanceTeacher();
    ...
    private void initialize() {
        ...
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage(AttendanceTeacher.class.getResource("/GUI/image/DIT_University_Dehradun_Logo.jpg")));
